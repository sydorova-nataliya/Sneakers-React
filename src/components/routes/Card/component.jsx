...
const Card = ({id, name, price, imageURL, onClick, onFavorite, favorited = false, loading = false})=>{
  ...
  <div className="card" key={id}>
    {isFavorite ?  <img  className='cu-p' src="img/liked.svg" alt="like" onClick={handleFavorite}/> : <img className='card__like cu-p ' src="img/like.svg" alt="like" onClick={handleFavorite}/>}
